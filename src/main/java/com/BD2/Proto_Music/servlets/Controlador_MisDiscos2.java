 ...
 * @author esteban
 */
@WebServlet(name = "Controlador_MisDiscos2", urlPatterns = {"/Controlador_MisDiscos2"})
public class Controlador_MisDiscos2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Controlador_MisDiscos2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Controlador_MisDiscos2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Disco> mis_discos = conexion.retonarMisDiscos(artista);
        ...
        {
           out.print("<h1>"+artista+" No tiene discos creados</h1>");
        }
    }
